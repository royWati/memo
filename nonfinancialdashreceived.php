...
?></div>
            ...
            <section class="content">
                ...
                <form action="nonfinancialmemoviewreceived.php?referenceno=<?php echo $_GET['referenceno'];?>&&subject=<?php echo $_GET['subject'];?>&&introduction=<?php echo $_GET['introduction'];?>" method="post">
                            <button type="submit" class="btn btn-outline-info" name="submit">View and Edit Memo Contents</button>
                    </form>
                <div class="row quick-stats">
                    <div class="col-sm-6 col-md-6">
                        <div id="qstatspia" class="quick-stats__item">
                            <div id="qstats" class="quick-stats__info">
                                 <h2>My Status</h2></br><h2 id="hech2"><?php $status=$_GET['status']; echo $status; ?></h2></br></br>
                    <h2>My Progress</h2></br> <div class="progress mt-1">
                          
                                            <div id="progbar" class="progress-bar bg-info" role="progressbar" style="width: <?php   $progress=$_GET['progress'];  echo $progress; ?>%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                    </div>
 ...
 <div class="col-sm-6 col-md-6">
                        <div id="qstatspia" class="quick-stats__item">
                            <div id="qstats" class="quick-stats__info">
                                <h2>General Status</h2></br><h2 id="hech2"><?php $generalstatus=$_GET['generalstatus']; echo $generalstatus; ?></h2></br></br>
                    <h2>General Progress</h2></br> <div class="progress mt-1">
                          
                                            <div id="progbar" class="progress-bar bg-info" role="progressbar" style="width: <?php   $generalprogress=$_GET['generalprogress'];  echo $generalprogress; ?>%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div id="qstatspia" class="quick-stats__item">
                            <div id="qstats" class="quick-stats__info">
                                <h2>All Memo Participants</h2></br></br>
...
$query="SELECT * FROM nonfinancialmemos WHERE referenceno='$referenceno' ORDER BY id DESC ";
//execute query
if ($db->real_query($query)) {
    ...
    while ($row = $res->fetch_assoc()) {
        ...
        echo  "<td><div class=\"progress mt-1\">
                                    <div class=\"progress-bar bg-info\" role=\"progressbar\" style=\"width: $progress%\" aria-valuenow=\"55\" aria-valuemin=\"0\" aria-valuemax=\"100\"></div>
                                </div>
                            </td>";
