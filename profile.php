                ...
                <header class="content__title">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div id="qstatspia" class="quick-stats__item">
                            ...
                            <img id="userimg" class="user__img" src="demo/img/profile-pics/cyroo.jpg" alt=""></br>
                                <small>Mr. Cyrus Kiprotich</small></br>
                        <small>CO</small></br>
                              <small>Department of IT</small></br>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                <p><i id="mee" class="zmdi zmdi-money-box zmdi-hc-5x"></i> <h1>15</h1>Budget</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                ...
                                <p><i id="mee" class="zmdi zmdi-receipt zmdi-hc-5x"></i> <h1>30</h1>Financial Memo</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                ...
                                <p><i id="mee" class="zmdi zmdi-receipt zmdi-hc-5x"></i> <h1>12</h1>Non-Financial Memo</p>
                            </div>
                        </div>
                    </div>
                </div>
     <div class="row quick-stats">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            ...
                            <button type="submit" class="btn btn-outline-info" name="submit">Create New Budget Memo</button>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            ...
                            <a href="memocreation.php"><button type="submit" class="btn btn-outline-info" name="submit">Create New Financial Memo</button></a>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            ...
                            <button type="submit" class="btn btn-outline-info" name="submit">Create New Non-Financial Memo</button>
                            </div>
                        </div>
                    </div>
                </div>
