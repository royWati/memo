...
?></div>
            ...
            <ul class="navigation">
                ...
                <li class="navigation__active"><a href="index.php"><i id="mee" class="zmdi zmdi-home"></i> Home</a></li>


                <li class="@@typeactive"><a href=""><i id="mee" class="zmdi zmdi-collection-plus"></i>Create memo</a></li>
                ...
                <li class="navigation__sub @@tableactive">
                    <a href="#"><i id="mee" class="zmdi zmdi-storage"></i> Storage Cabinate</a>
                ...
                <li class="navigation__sub @@uiactive">
                    <a href="#"><i id="mee" class="zmdi zmdi-notifications"></i> Send Notification</a>
                </li>
    ...
    <section class="content">
        <header class="content__title">
            <h1>FINANCIAL MEMO FORM</h1>
        </header>
        <form action="financialmemocreation.php" method="post">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            ...
                            <label>Will be autogenerated when form is submitted</label>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <label>To.(only add more recepients if you need to)</label>
                ...
                <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group"> 
                                        <select name="firstrecepient"class="select2">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <select name="secondrecepient"class="select2">
                                <option value="null">Second recepient</option>
                                <option value="Approved-Vendor">Approved Vendor</option>
                                <option value="New-Vendor">New Vendor</option>
                            </select>
                                        <i class="form-group__bar"></i>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                <select name="thirdrecepient"class="select2">
                                <option value="null">Third recepient</option>
                                <option value="Approved-Vendor">Approved Vendor</option>
                                <option value="New-Vendor">New Vendor</option>
                            </select>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <select name="fourthrecepient"class="select2">
                                <option value="null">Fourth recepient</option>
                                <option value="Approved-Vendor">Approved Vendor</option>
                                <option value="New-Vendor">New Vendor</option>
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            <select name="vendortype"class="select2">
...
<div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            <label>Attach File(s)</label></br>
                            <small>Attach atleast 3 quaotations for new vendor</small>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                            ...
                            <label>Vendor Remarks(if any).</label>

                        </div>
                    </div>
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                    <textarea name="vendorremarks"></textarea>
                    <script>
                        CKEDITOR.replace( 'vendorremarks' );
                    </script>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            ...
                            <input type="number" name="budgetyear" class="form-control" >
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            <input type="text" name="budgetitem" class="form-control" >
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        <div class="form-group">
                            <input type="number" name="amount" class="form-control" placeholder="Kshs" >
               ...
               <button type="submit" class="btn btn-outline-success" name="submit">Add Memo
                        </button>
...
$sql="insert into financialmemos(referenceno,firstrecepient,secondrecepient,thirdrecepient,fourthrecepient,requestor,subject,duedate,introduction,vendortype,attachment1,attachment2,attachment3,vendorremarks,budgetyear,budgetitem,amount)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
if($stmnt=$mysqli->prepare($sql)){
    ...
    $attachment2='mambo';
    $attachment3='mambo';
$stmnt->bind_param('ssssssssssssssisi',$referenceno,$_POST['firstrecepient'],$_POST['secondrecepient'],$_POST['thirdrecepient'],$_POST['fourthrecepient'],$_POST['requestor'],$_POST['subject'],$_POST['duedate'],$_POST['introduction'],$_POST['vendortype'],$attachment1,$attachment2,$attachment3,$_POST['vendorremarks'],$_POST['budgetyear'],$_POST['budgetitem'],$_POST['amount']);
    $stmnt->execute();
