                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                <p><i id="me" class="zmdi zmdi-arrow-left-bottom zmdi-hc-5x"></i> <h1>15</h1>Received Memos</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                ...
                                <p><i id="me" class="zmdi zmdi-arrow-right-top zmdi-hc-5x"></i> <h1>30</h1>Sent Memos</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="quick-stats__item">
                            <div class="quick-stats__info">
                                ...
                                <p><i id="me" class="zmdi zmdi-edit zmdi-hc-5x"></i> <h1>12</h1>Memos in Draft</p>
                            </div>
                        </div>
                    </div>
                </div>
