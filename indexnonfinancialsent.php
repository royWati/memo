...
?></div>
            ...
            <section class="content">
                <header class="content__title">
                    <h1>Non-Financial Memo Sent Requests Dashboard</h1>
                </header>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                          <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Sent Memos</h4>
                                <h6 class="card-subtitle">Below are memos sent to other departments. Keep track</h6>
                                <div class="card">
                                    <div id="chatOutputSent" class="card-body">
