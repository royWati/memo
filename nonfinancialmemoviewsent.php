...
?></div>
            ...
            <section class="content">
                <header class="content__title">
                    <h1>Title of Memo:  <?php   $title=$_GET['title'];  echo $title; ?>  </h1>
                    <small>Receiving Department:  <?php   $receivingdpt=$_GET['receivingdpt'];  echo $receivingdpt; ?></small>
                      <div class="progress mt-1">
                          
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?php   $progress=$_GET['progress'];  echo $progress; ?>%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                    <small>Status:  <?php   $status=$_GET['status'];  echo $status; ?></small>
...
if ($db->real_query($query)) {
    ...
    while ($row = $res->fetch_assoc()) {
         $id=$row["id"];
        $title=$row["title"];
        $sendingdpt=$row["sendingdpt"];
        $receivingdpt=$row["receivingdpt"];
        $duedate=$row["duedate"];
        $memobody=$row["memobody"];
...
$db->close();
                ...
                <form action="memoviewsent.php?id=<?php echo $_GET['id'];?>&&memobody=<?php echo $_GET['memobody'];?>&&title=<?php echo $_GET['title'];?>&&receivingdpt=<?php echo $_GET['receivingdpt'];?>&&status=<?php echo $_GET['status'];?>" method="post">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                <div class="card">
                                    <div class="card-body">
                                         ...
                                         <textarea name="memobody"><?php  echo $memobody?></textarea>
                          <script>
            ...
            <div class="card-body">
                ...
                <h6 class="card-subtitle">Reply to comments if any</h6>
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="form-group">
                       <button type="submit" class="btn btn-outline-success" name="respond">Comment response
                        </button>
...
if(isset($_POST['respond'])){
  ...
  //update the body  
$sql="UPDATE memos SET memobody='$mem' WHERE id=$id";
    ...
    //update the progress
            ...
            ?>        
                ...
                <form action="viewfinalmemo.php?id=<?php echo $_GET['id'];?>&&memobody=<?php echo $_GET['memobody'];?>&&title=<?php echo $_GET['title'];?>&&receivingdpt=<?php echo $_GET['receivingdpt'];?>&&status=<?php echo $_GET['status'];?>" method="post">
                    <div class="row">
                    <div class="col-sm-6 col-md-4">
                          <div class="form-group">
                        </div>
                        
                <h6 class="card-subtitle">View the final approved memo</h6>
                        
                            <div class="form-group">
                       <button type="submit" class="btn btn-outline-success" name="viewfinal">View final memo
                        </button>
